      ...
      {currentAlert && (
        ...
        >
          ...
          >
            ...
            {/* Content: XP + reward state (variable height) */}
            <div className="px-6 pt-1 pb-4 min-h-[100px]">
              <motion.div
              ...
              {currentAlert.achievement.reward && !showReward && (
                <motion.div
                  ...
                  className="rounded-xl bg-discord-darker/80 border border-white/10 p-3 text-center"
                >
              ...
              {showReward && currentAlert.achievement.reward && (
                <motion.div
                  ...
                  className="rounded-xl bg-gradient-to-b from-cyber-neon/10 to-discord-darker/80 border border-cyber-neon/20 p-4 text-center"
                >
                  <motion.div
                    initial={{ scale: 0 }}
            ...
            {/* Fixed action bar — button always in same place */}
